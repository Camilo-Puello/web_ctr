...
@section('admin')
  ...
  <!-- fondo Noticia-->
  <section class="breadcrumb fondo_noticias" style="margin-top: 0%;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item" >
                            <h2 style="margin-left: 20%;">Editor de Noticias</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
             <div class="row">
               <div class="col-md-3">
                 <a href="#" class="btn btn-primary btn-block mb-3">Control Noticias</a>
               ...
               <div class="col-sm-9">
                 <div class="card card-primary card-outline" >
                   <div class="card-header">
                     <h3 class="card-title"><i class="ion ion-clipboard mr-1"></i>Lista de Noticias</h3>
                     <!-- /.card-tools -->
                   </div>
                   <!-- /.card-header -->
                   <div class="card-body p-0">
                         ...
                         <tr>
                          ...
                          <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <td>{{ $pos->id }}</td>
                                <td>{{ $pos->tittle }}</td>
                                <td>{!! getShorterString ($pos['content'], 50) !!}</td>
                                <td><img src="{{ asset('/public/images/noticias/'.$pos['image_url']) }}" style="width:200px;" alt=""></td>                                
                                <td>{{ $pos->user['name'] }}</td>                               
                                <td>
                                <div class="mailbox-controls">
                                     <!-- Check all button -->                        
                                     <div class="btn-group">                                                                          
                                          <button type="button" class="btn btn-primary btn-sm"><a href="/posts/{{ $pos->id }}/edit" style="text-decoration: none; color: #fff;"><svg class="bi bi-pencil" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin-top: -5px;">
                                          ...
                                          {!! Form::open(['route' => ['posts.destroy', $pos->id ],
                                          'method' => 'DELETE']) !!} 
                                         <button class="btn btn-sm btn-danger"><i class="fas fa-trash-alt" style="color: #fff;"></i></a></button>
                                         {!! Form::close() !!}
