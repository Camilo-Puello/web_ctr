		...
		<div class="container-login100">
			<div class="wrap-login100">
                <form class="login100-form validate-form" method="POST" action="{{ route('login') }}">
					...
					<div class="wrap-input100 validate-input" data-validate = "Se requiere el e-mail">
					...
					<div class="wrap-input100 validate-input" data-validate="Se requiere la contraseña" style="margin-top: 50px;">
