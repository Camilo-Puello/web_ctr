...
@section('admin')
    ...
    <section class="breadcrumb fondo_lider" style="margin-top: 0%;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item" >
                            <h2 style="margin-left: 20%;">Elige tu Lider</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <a href="#" class="btn btn-primary btn-block mb-3">Control de Lideres</a>
    ...
    <ul class="nav nav-pills flex-column">
      <li class="nav-item active">
        ...
        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-hand-index" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin-right: 5px;">
          ...
          <span class="badge bg-primary float-right">{{ $lider_count }}</span>
        </a>
      </li>
      ...
      <li class="nav-item">          
         <a href="#" class="nav-link" style="float: left;">
         <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-search" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin-right: 5px;">
            <path fill-rule="evenodd" d="M10.442 10.442a1 1 0 0 1 1.415 0l3.85 3.85a1 1 0 0 1-1.414 1.415l-3.85-3.85a1 1 0 0 1 0-1.415z"/>
            <path fill-rule="evenodd" d="M6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zM13 6.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0z"/>
          </svg> Consulta            
               <a href="{{route('lider.consulta')}}"
                  class="btn btn-sm btn-success float-right" style="margin: 5px;">
                 Consultar lider
               </a>              
         </a>
      </li>
                                     ...
                                     <table class="table table-striped table-hover">
                                         ...
                                         @foreach ($lider as $item)
                                             ...
                                             <div class="mailbox-controls">
                                                ...
                                                @can('lider.show')
                                                <a href="{{ route('lider.show', $item->id)}}">
                                                ...
                                                @can('lider.edit')
                                                <a href="{{ route('lider.edit', $item->id)}}">
                                                ...
                                                @can('lider.destroy')
                                                {!! Form::open(['route' => ['lider.destroy', $item->id ],
                                                 'method' => 'DELETE']) !!}
