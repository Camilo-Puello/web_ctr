...
@section('admin')
    ...
    <section class="breadcrumb fondo_camioneros" style="margin-top: 0%;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item" >
                            <h2 style="margin-left: 20%;">Conductores</h2>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-3">
        <a href="#" class="btn btn-primary btn-block mb-3">Control Curriculun</a>
...
<ul class="nav nav-pills flex-column">
  <li class="nav-item active">
    ...
    <svg class="bi bi-truck" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin-right: 5px;">
      ...
      <span class="badge bg-primary float-right">{{ $transp_count }}</span>
    </a>
  </li>
          ...
          <div class="card card-primary card-outline" >
            <div class="card-header">
              ...
              <div class="col-md-12">
                  ...
                  <h3 class="card-title"> <i class="ion ion-clipboard mr-1"></i>Lista de Curriculum</h3>
                                     ...
                                     <table class="table table-striped table-hover">
                                         ...
                                         @foreach ($transporte as $item)
                                             ...
                                             <td>{{ $item->id }}</td>
                                                <td>{{ $item->name }}</td>
                                                <td>{{ $item->apellido }}</td>
                                                <td><img src="{{ asset('/public/images/conductores/'.$item->logo) }}" style="width:32px; height:32px; top:10px; left:10px; border-radius:50%;"/></td>
                                                <td>{{ $item->correo }}</td>
                                                <td>                                                  
                                             ...
                                             <div class="mailbox-controls">
                                                ...
                                                @can('transportes.show')
                                                    <a href="{{ route('transportes.show', $item->id)}}">
                                                    ...
                                                    <a href="{{ route('transportes.edit', $item->id)}}">
                                                    ...
                                                    {!! Form::open(['route' => ['transportes.destroy', $item->id ],
                                                    'method' => 'DELETE']) !!}
