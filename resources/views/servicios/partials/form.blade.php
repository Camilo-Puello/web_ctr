        ...
        <div class="rom">
            ...
            <div class="card">
               <div class="card-header bg-primary" style="color: #fff;">
                ...
                <div class="card-body">
                   ...
                   <div class="col-md-6">
                    <div class="form-group">
                        {{ Form::label('h_salida', 'Hora de Salida') }}
                        {{ Form::time('h_salida', null, ['class' => 'form-control']) }}
                    </div>
                   ...
                   <div class="col-md-6">
                    <div class="form-group">
                        {{ Form::label('h_llegada', 'Hora de LLegada') }}
                        {{ Form::time('h_llegada', null, ['class' => 'form-control']) }}
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        {{ Form::label('capacidad_d', 'Capacidad de Carga') }}
                        {{ Form::text('capacidad_d', null, ['class' => 'form-control']) }}
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        {{ Form::label('vehiculo', 'Tipo de Vehiculo') }}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        {{ Form::label('contacto', 'Telefono de Contacto') }}
