...
@section('admin')
    <body class="hold-transition sidebar-mini layout-fixed">
     ...
     <section class="breadcrumb fondo_serv" style="margin-top: 0%;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item" >
                            <h2 style="margin-left: 20%;">Crear Servicios</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3" >
                 ...
                 <a href="#" class="btn btn-primary btn-block mb-3">Control Servicios</a>
                     ...
                     <ul class="nav nav-pills flex-column">
                       ...
                       <li class="nav-item active">
                         ...
                         <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-headset" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin-right: 5px;">
                           ...
                           <span class="badge bg-primary float-right">{{ $servicio_count}} </span>                      
                         </a>                         
                       </li>
                       <li class="nav-item">          
          ...
          <div class="card card-primary card-outline" >
            <div class="card-header">
              ...
              <div class="col-md-12">
                  ...
                  <h3 class="card-title"> <i class="ion ion-clipboard mr-1"></i>Lista de Servicios</h3>
                                 ...
                                 <table class="table-responsive-xl">                                         
                                     <table class="table table-striped table-hover">
                                         ...
                                         @foreach ($servicio as $item)
                                                    ...
                                                    <td>{{ $item->origen }}</td>
                                                    <td>{{ $item->destino }}</td>
                                                    <td><img src="{{ asset('/public/images/servicios/logos/'.$item->logo) }}" style="width:32px; height:32px; top:10px; left:10px; border-radius:50%;"/></td>
                                                    <td width="10px">                                                    
                                             ...
                                             <div class="mailbox-controls">
                                                       ...
                                                       <div class="btn-group">                                                     
                                                        ...
                                                        {!! Form::open(['route' => ['servicios.destroy', $item->id ],
                                                         'method' => 'DELETE']) !!}
