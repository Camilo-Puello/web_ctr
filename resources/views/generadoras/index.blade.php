...
@section('admin')
    ...
    <section class="breadcrumb fondo_generadora" style="margin-top: 0%;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item" >
                            <h2 style="margin-left: 20%;">Generadoras</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="content-wrapper" >
        ...
        <div class="container">
            ...
            <div class="row" >
              <div class="col-md-3">                
                  <a href="#" class="btn btn-primary btn-block mb-3">Control de Empresas</a>
                    <div class="card">
                        ...
                        <ul class="nav nav-pills flex-column">
                          <li class="nav-item active">
                            ...
                            <svg class="bi bi-box-seam" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin-right: 5px;">
                              ...
                              <span class="badge bg-primary float-right">{{ $generadora_count }}</span>
                            </a>
                          </li>
                          <li class="nav-item">          
                              <a href="#" class="nav-link" style="float: left;">
                               <svg class="bi bi-plus-circle" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                   ...
                                   <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                    ...
                                    <a href="{{route('generadoras.create')}}"
                 ...
                 <div class="card card-primary card-outline" >
                   <div class="card-header">
                     ...
                     <div class="col-md-12">
                         ...
                         <h3 class="card-title"> <i class="ion ion-clipboard mr-1"></i>Lista de Empresas</h3>
                                        ...
                                        <table class="table-responsive-xl">                                         
                                            <table class="table table-striped table-hover">
                                                ...
                                                @foreach ($generadora as $item)
                                                    ...
                                                    <td>{{ $item->cel }}</td>
                                                    <td>{{ $item->correo }}</td>
                                                    <td><img src="{{ asset('/public/images/generadoras/logos/'.$item->logo) }}" style="width:32px; height:32px; top:10px; left:10px; border-radius:50%;"/></td>
                                                    <td>                                                   
                                                    ...
                                                    <div class="mailbox-controls">
                                                       ...
                                                       @can('generadoras.show')
                                                        <a href="{{ route('generadoras.show', $item->id)}}">
                                                        ...
                                                        @can('generadoras.edit')
                                                        <a href="{{ route('generadoras.edit', $item->id)}}">
                                                        ...
                                                        @can('generadoras.destroy')
                                                        {!! Form::open(['route' => ['generadoras.destroy', $item->id ],
                                                        'method' => 'DELETE']) !!}
