    ...
    <!-- Add icons to the links using the .nav-icon class
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
           ...
           <section class="breadcrumb fondo_roles" style="margin-top: 0%;">
               <div class="container">
                   <div class="row">
                       <div class="col-lg-12">
                           <div class="breadcrumb_iner text-center">
                               <div class="breadcrumb_iner_item" >
                                   <h2 style="margin-left: 20%;">Roles</h2>
                               </div>
                           </div>
                       </div>
                   </div>
    ...
    <div class="col-md-12">
        <div class="content-wrapper">
           ...
           <section class="content">
             <div class="row">
               <div class="col-md-3">
                 <a href="#" class="btn btn-primary btn-block mb-3">Control Roles</a>
                     ...
                     <ul class="nav nav-pills flex-column">
                       <li class="nav-item active">
                         <a href="#" class="nav-link">
                           ...
                           <span class="badge bg-primary float-right">{{ $rol_count}}</span>
                         </a>
                       </li>
                       <li class="nav-item">          
                                     ...
                                     <div class="btn-group">
                                      ...
                                      @can('roles.show')
                                         <a href="{{ route('roles.show', $role->id)}}">
                                            <button type="button" class="btn btn-success btn-sm"><svg class="bi bi-eye-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin-top: -5px;">
                                            <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"/>
                                            <path fill-rule="evenodd" d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/>
                                            </svg>
                                            </button>
                                      ...
                                      @can('roles.edit')                                      
                                          <button type="button" class="btn btn-primary btn-sm"><a href="{{ route('roles.edit', $role->id)}}" style="text-decoration: none; color: #fff;"><svg class="bi bi-pencil" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin-top: -5px;">
