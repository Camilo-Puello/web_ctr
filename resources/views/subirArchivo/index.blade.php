...
@section('admin')
    ...
    <section class="breadcrumb fondo_archivos" style="margin-top: 0%;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item" >
                            <h2 style="margin-left: 20%;">Mis Archivos</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                 ...
                 <a href="#" class="btn btn-primary btn-block mb-3">Control de Archivos</a>
                     ...
                     <div class="card-body p-0">
                       <ul class="nav nav-pills flex-column">
                         <li class="nav-item active">
                           ...
                           <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-zip-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin-right: 5px;">
                            <path fill-rule="evenodd" d="M8 1h4a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h2.5v1h1v1h-1v1h1v1h-1v1h1v1H9V6H8V5h1V4H8V3h1V2H8V1zM6.5 8.5a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1v.938l.4 1.599a1 1 0 0 1-.416 1.074l-.93.62a1 1 0 0 1-1.109 0l-.93-.62a1 1 0 0 1-.415-1.074l.4-1.599V8.5zm2 .938V8.5h-1v.938a1 1 0 0 1-.03.243l-.4 1.598.93.62.93-.62-.4-1.598a1 1 0 0 1-.03-.243z"/>
                           </svg> Archivos
                             <span class="badge bg-primary float-right">{{ $subir_count }}</span>
                           </a>
                         </li>
                         <li class="nav-item">          
                            ...
                            <svg class="bi bi-plus-circle" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                                  ...
                                  <a href="{{route('subirArchivo.create')}}"
          ...
          <div class="card card-primary card-outline" >
            <div class="card-header">
              ...
              <div class="col-md-12">
                  ...
                  <h3 class="card-title"> <i class="ion ion-clipboard mr-1"></i>Lista de Archivos</h3>
                                         ...
                                         @foreach ($subir as $item)
                                            ...
                                            <td>                                                    
                                             ...
                                             <div class="mailbox-controls">
                                                ...
                                                @can('subirArchivo.show')
                                                        <a href="{{ route('subirArchivo.show', $item->id)}}">
                                                        ...
                                                        @can('subirArchivo.edit')
                                                        <a href="{{ route('subirArchivo.edit', $item->id)}}">
                                                        ...
                                                        @can('subirArchivo.destroy')
                                                        {!! Form::open(['route' => ['subirArchivo.destroy', $item->id ],
                                                        'method' => 'DELETE']) !!}
