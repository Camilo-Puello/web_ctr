...
@section('admin')
    ...
    <section class="breadcrumb fondo_empresa" style="margin-top: 0%;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb_iner text-center">
                        <div class="breadcrumb_iner_item" >
                            <h2 style="margin-left: 20%;">Transportadoras</h2>
                        </div>
                    </div>
                </div>
            </div>
                                         ...
                                         @foreach ($emp as $item)
                                             ...
                                             <div class="mailbox-controls">
                                                ...
                                                @can('empresa.show')
                                                 ...
                                                 @can('empresa.edit')
                                                 <a href="{{ route('empresa.edit', $item->id)}}">
                                                 ...
                                                 @can('empresa.destroy')
                                                 {!! Form::open(['route' => ['empresa.destroy', $item->id ],
                                                  'method' => 'DELETE']) !!}
