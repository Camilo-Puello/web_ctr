    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
          ...
          <aside class="main-sidebar sidebar-dark-primary elevation-4" >
              ...
              @can('users.index')
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  <!-- Add icons to the links using the .nav-icon class
                       with font-awesome or any other icon font library -->
                        <li class="nav-item has-treeview menu-close">
                          <a href="{{ route('empresa.index') }}" class="nav-link active">
                          <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-headset" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin-right: 5px;">
                          ...
                          <ul class="nav nav-treeview">
                            <li class="nav-item">
                              <a href="{{ route('servicios.index') }}" class="nav-link active">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  <!-- Add icons to the links using the .nav-icon class
                    ...
                    @endcan
                    @can('subirArchivo.index')
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <!-- Add icons to the links using the .nav-icon class
                             with font-awesome or any other icon font library -->
                              <li class="nav-item has-treeview menu-close">
                                <a href="{{ route('subirArchivo.index') }}" class="nav-link active">
                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-zip-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="margin-right: 2px;">
            ...
            <!-- fondo transportadora-->
           <section class="breadcrumb fondo_users" style="margin-top: 0%;">
               <div class="container">
                   <div class="row">
                       <div class="col-lg-12">
                           <div class="breadcrumb_iner text-center">
                               <div class="breadcrumb_iner_item" >
                                   <h2 style="margin-left: 20%;">Usuarios</h2>
                               </div>
                           </div>
                       </div>
                   </div>
    ...
    <div class="col-md-12">
        <div class="content-wrapper">
           ...
           <section class="content-header">
             <div class="container-fluid">
               <div class="row mb-2">
                 ...
                 <!-- Buscador -->
                 <div class="col-sm-6">
                    <form class="card-tools float-right">
           ...
           <section class="content">
             <div class="row">
               <div class="col-md-3">
                 <a href="#" class="btn btn-primary btn-block mb-3">Control usuarios</a>
                     ...
                     <ul class="nav nav-pills flex-column">
                       ...
                       <li class="nav-item active">
                         <a href="#" class="nav-link">
                           ...
                           <span class="badge bg-primary float-right">{{ $users_count}} </span>
                       ...
                       <li class="nav-item">
                         <a href="#" class="nav-link">
                            <svg class="bi bi-pencil-square" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg"  style="margin-right: 2px;">
                       ...
                       <li class="nav-item">
                         <a href="#" class="nav-link">
                           <i class="far fa-trash-alt"></i> Borrados
                     ...
                     <ul class="nav nav-pills flex-column">
                       <li class="nav-item">
                         <a href="#" class="nav-link">
                           ...
                           Link
                           <span class="badge bg-success float-right">435</span>
                         </a>

                       </li>
                       <li class="nav-item">
                         <a href="#" class="nav-link">
                           <i class="far fa-circle text-warning"></i> Comentarios
                           <span class="badge bg-success float-right">102</span>
                         </a>
                       ...
                       <li class="nav-item">
                         <a href="#" class="nav-link">
                           ...
                           Imagenes
                           <span class="badge bg-success float-right">25</span>
                         </a>
                         ...
                         <tr>
                          ...
                          <table class="table table-hover table-striped">
                           ...
                           <tbody>
                               ...
                               <td>{{ $user->name }}</td>
                               <td>{{ $user->email }}</td>
                               <td><img src="{{ asset('/uploads/avatars/'.$user['avatar']) }}" style="width:32px; height:32px; top:10px; left:10px; border-radius:50%;" alt="avatar-user"></td>
                               <td width="10px">
                               <div class="mailbox-controls">
                                   ...
                                   'method' => 'DELETE']) !!}
                                      <button class="btn btn-sm btn-danger"><i class="fas fa-trash-alt" style="color: #fff;"></i></button>
                                    {!! Form::close() !!}
                                    @endcan
